    ...
    public static String insertHeadp(MultipartFile file, String filePath) {
        ...
        if (!file.isEmpty()) {
            try {
                ...
                String headPathOut = "/Users/quinn_norris/Desktop/PROJECT/Learning/QuinnNorris/out/artifacts/QuinnNorris_warE/headp";
                String[] filetype = file.getContentType().split("/");
                String fileName = DateUtil.continueDateFormat(new Date()) + "." + filetype[1];
                File targetFile = new File(filePath, fileName);
                File targetFile1 = new File(headPathOut, fileName);
